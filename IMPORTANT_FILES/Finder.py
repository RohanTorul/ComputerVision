...
class UAV_GROUND_PERCEPTION:
    def __init__(self,Source_of_fire_coordinate = None,source_description = None,position = (0,0),fov = 60,camera_index = 4):
        ...
        self.Ir_detector = HotspotDetector(camera_index= camera_index) #change cameraindex until it works ig.
...
def main(source_coordinates, Source_description, camera_index = 4):
    """
    Main function to run the UAV_GROUND_PERCEPTION class.
    """
    # Initialize the UAV_GROUND_PERCEPTION class
    uav_perception = UAV_GROUND_PERCEPTION(source_description=Source_description, Source_of_fire_coordinate=source_coordinates, camera_index=camera_index) # SEE HERE
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--camera_index", type=int, default=4, help="index of the camera to use")
    args = argparser.parse_args()
    if args.lat is None or args.lon is None or args.description is None:
        print("Invalid arguments")
    else:
        main(source_coordinates=(args.lon, args.lat),Source_description= args.description, camera_index=args.camera_index) #PARAMS HERE
